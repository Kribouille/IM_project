...
/**
 * This is the item provider adapter for a {@link twitterRESTAPI.Message} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Message_author_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Message_author_feature", "_UI_Message_type"),
				 TwitterRESTAPIPackage.Literals.MESSAGE__AUTHOR,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addRecipientPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Message_recipient_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Message_recipient_feature", "_UI_Message_type"),
				 TwitterRESTAPIPackage.Literals.MESSAGE__RECIPIENT,
				 true,
				 false,
				 true,
				 null,
