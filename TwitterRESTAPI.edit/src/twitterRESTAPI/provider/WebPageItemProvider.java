...
/**
 * This is the item provider adapter for a {@link twitterRESTAPI.WebPage} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class WebPageItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(TwitterRESTAPIPackage.Literals.WEB_PAGE__DECK);
		}
	...
	public String getText(Object object) {
		return getString("_UI_WebPage_type");
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(WebPage.class)) {
			case TwitterRESTAPIPackage.WEB_PAGE__DECK:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(TwitterRESTAPIPackage.Literals.WEB_PAGE__DECK,
				 TwitterRESTAPIFactory.eINSTANCE.createDeck()));
	}
